...
export function resolveConfiguration(
    ...
    const resolvedConfig: ResolvedTypeScriptConfiguration = {
        ...
        "exportDefaultExpression.semiColon": getValue("exportDefaultExpression.semiColon", semiColons, ensureBoolean),
        ...
        "importDeclaration.spaceSurroundingNamedImports": getValue("importDeclaration.spaceSurroundingNamedImports",
            defaultValues["importDeclaration.spaceSurroundingNamedImports"], ensureBoolean),
