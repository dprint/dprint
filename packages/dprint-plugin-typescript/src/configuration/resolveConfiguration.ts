...
export function resolveConfiguration(
    ...
    const resolvedConfig: ResolvedTypeScriptConfiguration = {
        ...
        // use spaces
        "binaryExpression.spaceSurroundingOperator": getValue("binaryExpression.spaceSurroundingOperator", defaultValues["binaryExpression.spaceSurroundingOperator"],
            ensureBoolean),
        ...
        "constructSignature.spaceAfterNewKeyword": getValue("constructSignature.spaceAfterNewKeyword", defaultValues["constructSignature.spaceAfterNewKeyword"],
            ensureBoolean),
        "doWhileStatement.spaceAfterWhileKeyword": getValue("doWhileStatement.spaceAfterWhileKeyword", defaultValues["doWhileStatement.spaceAfterWhileKeyword"],
            ensureBoolean),
        "exportDeclaration.spaceSurroundingNamedExports": getValue("exportDeclaration.spaceSurroundingNamedExports", defaultValues["exportDeclaration.spaceSurroundingNamedExports"],
            ensureBoolean),
        ...
        "functionDeclaration.spaceBeforeParentheses": getValue("functionDeclaration.spaceBeforeParentheses", defaultValues["functionDeclaration.spaceBeforeParentheses"],
            ensureBoolean),
        "functionExpression.spaceBeforeParentheses": getValue("functionExpression.spaceBeforeParentheses", defaultValues["functionExpression.spaceBeforeParentheses"],
            ensureBoolean),
        ...
        "importDeclaration.spaceSurroundingNamedExports": getValue("importDeclaration.spaceSurroundingNamedExports", defaultValues["importDeclaration.spaceSurroundingNamedExports"],
            ensureBoolean),
