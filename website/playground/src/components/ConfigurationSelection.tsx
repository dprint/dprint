...
export class ConfigurationSelection extends React.Component<ConfigurationSelectionProps> {
    ...
    private getBooleanConfig(configKey: any) {
    ...
    private getSelectForConfig(configKey: any, values: readonly string[]) {
        const { config } = this.props;
        return (
    ...
    private getNumberConfig(configKey: any) {
        const { config } = this.props;
        return (
    ...
    private updateConfig(newConfig: any /*Partial<TypeScriptConfiguration>*/) {
