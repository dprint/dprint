...
use super::ImportObjectFactory;

/// Loads a compiled wasm module from the specified bytes.
pub fn load_instance(compiled_module_bytes: &[u8], import_object_factory: &impl ImportObjectFactory) -> Result<wasmer_runtime::Instance, ErrBox> {
    ...
    let import_object = import_object_factory.create_import_object();
