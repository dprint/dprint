...
mod test {
    ...
    "c": {
        ...
        expected_manifest.add_item(String::from("a"), CacheItem {
            file_name: String::from("b"),
            created_time: 123,
            meta_data: None,
        });
        expected_manifest.add_item(String::from("c"), CacheItem {
    ...
    fn it_save_manifest() {
        ...
        manifest.add_item(String::from("a"), CacheItem {
            file_name: String::from("b"),
            created_time: 123,
            meta_data: None,
        });
        manifest.add_item(String::from("c"), CacheItem {
            file_name: String::from("d"),
            created_time: 456,
