...
impl<TEnvironment: Environment> IncrementalFile<TEnvironment> {
    ...
    pub fn is_file_same(&self, file_path: &PathBuf, file_text: &str) -> bool {
    ...
    pub fn update_file(&self, file_path: &PathBuf, file_text: &str) {
    ...
    fn standardize_path(&self, file_path: &PathBuf) -> PathBuf {
...
fn read_incremental(file_path: &PathBuf, environment: &impl Environment) -> Option<IncrementalFileData> {
...
fn write_incremental(file_path: &PathBuf, file_data: &IncrementalFileData, environment: &impl Environment) {
